<footer class="container flex items-center justify-between border-t border-comment py-20">
    <a class="uppercase" href="/">urboifox</a>
    <div class="flex items-center gap-4">
        ...
        <a
            class="text-comment transition-colors duration-200 hover:text-accent"
            href="https://facebook.com/urboifox"
            aria-label="Facebook"
            target="_blank"
        >
            <svg
